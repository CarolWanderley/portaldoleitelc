...
// @HASH:50f8addd41ce03aaf88cda299078961908ab47f2
// @DATE:Wed Nov 25 23:27:34 GMT-03:00 2015
...
// @LINE:7
private[this] lazy val controllers_Login_logout1 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("logout"))))
        

// @LINE:10
private[this] lazy val controllers_Login_show2 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
        

// @LINE:11
private[this] lazy val controllers_Login_authenticate3 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("login"))))
        

// @LINE:14
private[this] lazy val controllers_Register_show4 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("registrar"))))
        

// @LINE:15
private[this] lazy val controllers_Register_register5 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("registrar"))))
        

// @LINE:18
private[this] lazy val controllers_Application_tema6 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("tema/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:19
private[this] lazy val controllers_Application_disciplina7 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("disciplina/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:20
private[this] lazy val controllers_Application_metadica8 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("metadica/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:22
private[this] lazy val controllers_Application_cadastrarDica9 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("cadastrarDica/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:23
private[this] lazy val controllers_Application_avaliarDificuldadeTema10 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("avaliar/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:24
private[this] lazy val controllers_Application_addDiscordanciaEmDica11 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("addDiscordancia/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:25
private[this] lazy val controllers_Application_upVoteDica12 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("upVoteDica/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:26
private[this] lazy val controllers_Application_upVoteMetaDica13 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("upVoteMetaDica/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:27
private[this] lazy val controllers_Application_addDiscordanciaEmMetaDica14 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("addDiscordanciaMeta/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:29
private[this] lazy val controllers_Application_cadastrarMetaDica15 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("cadastrarMetaDica/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:31
private[this] lazy val controllers_Application_denunciarDica16 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("denunciarDica/"),DynamicPart("id", """[^/]+""",true))))
        

// @LINE:32
private[this] lazy val controllers_Application_denunciarMetaDica17 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("denunciarMetaDica/"),DynamicPart("id", """[^/]+""",true))))
...
// @LINE:7
case controllers_Login_logout1(params) => {
   call { 
...
// @LINE:10
case controllers_Login_show2(params) => {
   call { 
...
// @LINE:11
case controllers_Login_authenticate3(params) => {
   call { 
...
// @LINE:14
case controllers_Register_show4(params) => {
   call { 
...
// @LINE:15
case controllers_Register_register5(params) => {
   call { 
...
// @LINE:18
case controllers_Application_tema6(params) => {
...
// @LINE:19
case controllers_Application_disciplina7(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:20
case controllers_Application_metadica8(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:22
case controllers_Application_cadastrarDica9(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:23
case controllers_Application_avaliarDificuldadeTema10(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:24
case controllers_Application_addDiscordanciaEmDica11(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:25
case controllers_Application_upVoteDica12(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:26
case controllers_Application_upVoteMetaDica13(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:27
case controllers_Application_addDiscordanciaEmMetaDica14(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:29
case controllers_Application_cadastrarMetaDica15(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:31
case controllers_Application_denunciarDica16(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
...
// @LINE:32
case controllers_Application_denunciarMetaDica17(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
